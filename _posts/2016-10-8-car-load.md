...
总价格记为<img src="http://www.forkosh.com/mathtex.cgi? T">  
...
根据<img src="http://www.forkosh.com/mathtex.cgi? P_0=L-C">，最终可以得到  
...
调换一下变量顺序，最终得到  
<img src="http://www.forkosh.com/mathtex.cgi? C<=L\times({1+\frac{1}{N\times{I}\times({1+I})^N}-\frac{1}{N\times{I}}})">
...
<img src="http://www.forkosh.com/mathtex.cgi? C<=100000\times({1+\frac{1}{24\times{0.003}\times({1+0.003})^{24}}-\frac{1}{24\times{0.003}}})">  
<img src="http://www.forkosh.com/mathtex.cgi? C\approx{3653}">  
